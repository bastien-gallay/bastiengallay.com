...
| --- | --- | --- |
| Tag source (haut-gauche, mono caps) | variable | `METR · 2025` |
| Élément hero (centré sur le cercle, Redaction display rouge) | variable | `−19 %` |
| Numéro + titre court (bandeau bleu, mono caps crème) | variable | `§01.20 · CODER LENTEMENT` |
| Cercle jaune, bandeau bleu, cadre noir, filet noir séparateur | **constant** | (idem pour tous les articles) |

<div class="essai-mini"><svg class="essai-mini__cover" viewBox="0 0 360 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Miniature template : cercle jaune + chiffre rouge + bandeau bleu, instance -19 % METR"><rect x="0" y="0" width="360" height="240" fill="#f5efe6"/><circle cx="180" cy="92" r="78" fill="#ffd900"/><text x="20" y="28" font-family="ui-monospace, monospace" font-size="12" letter-spacing="2" fill="#111" font-weight="700">METR · 2025</text><text x="180" y="118" text-anchor="middle" fill="#b8252e" font-family="Redaction, Georgia, serif"><tspan font-size="64" font-weight="700">−19</tspan><tspan font-size="22" font-weight="500" dx="3">%</tspan></text><rect x="0" y="200" width="360" height="40" fill="#1f3d8c"/><line x1="0" y1="200" x2="360" y2="200" stroke="#111" stroke-width="3"/><text x="180" y="225" text-anchor="middle" font-family="ui-monospace, monospace" font-size="12" letter-spacing="2" fill="#f5efe6" font-weight="500">§01.20 · CODER LENTEMENT</text><rect x="0" y="0" width="360" height="240" fill="none" stroke="#111" stroke-width="3"/></svg><div class="essai-mini__body"><p class="essai-mini__date">27 mai 2026</p><p class="essai-mini__title">Avec l'IA, je code plus lentement</p><p class="essai-mini__legend">M4 · template hero-C + chiffre hero. Reproductible par article via 3 slots variables.</p></div></div>
