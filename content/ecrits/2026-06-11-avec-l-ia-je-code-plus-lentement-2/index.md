...
- <strong class="vsm-hot" data-vsm-group="4 5 6">Le code et sa boucle <span class="vsm-hot__n">· étapes 04–06</span></strong> : La responsabilité des 3 étapes suivantes est la mise en production d'un code de qualité. D'abord, l'élaboration du harnais qui garantit la qualité, puis la génération du code. Ensuite, différentes revues et intégrations prennent le relais. Ces trois étapes sont orchestrées par une boucle de rétroaction continue centrée sur la compréhension humaine et l'adaptation.
...
[^reflect-directive]: La directive telle qu'elle vit dans lucid-lint&nbsp;: *CODING_STANDARDS.md*, §3 «&nbsp;TDD with a fourth step — Reflect&nbsp;». Sa règle la plus dense&nbsp;: «&nbsp;*Reflect updates the plan, not the code.*&nbsp;» <https://github.com/bastien-gallay/lucid-lint/blob/main/CODING_STANDARDS.md#3-tdd-with-a-fourth-step--reflect>
