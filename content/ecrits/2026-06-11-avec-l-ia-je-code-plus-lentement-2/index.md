...
[^reflect-directive]: *lucid-lint* — *CODING_STANDARDS.md*, §3 «&nbsp;TDD with a fourth step — Reflect&nbsp;»&nbsp;: «&nbsp;*Reflect updates the plan, not the code.*&nbsp;» <https://github.com/bastien-gallay/lucid-lint/blob/main/CODING_STANDARDS.md#3-tdd-with-a-fourth-step--reflect>
